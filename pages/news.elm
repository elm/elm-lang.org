...
news : List News
news =
  [ News "Working with Files" "/blog/working-with-files"
  , News "Small Assets without the Headache" "/blog/small-assets-without-the-headache"
  , News "Google Summer of Code 2017" "/blog/google-summer-of-code-2017"
  , News "The Perfect Bug Report" "/blog/the-perfect-bug-report"
  , News "Blazing Fast HTML, Round Two" "/blog/blazing-fast-html-round-two"
  , News "How to Use Elm at Work" "/blog/how-to-use-elm-at-work"
  , News "A Farewell to FRP" "/blog/farewell-to-frp"
  , News "New Adventures for Elm" "/blog/new-adventures-for-elm"
  , News "Compilers as Assistants" "/blog/compilers-as-assistants"
  , News "Compiler Errors for Humans" "/blog/compiler-errors-for-humans"
  , News "Time Travel made Easy" "/blog/time-travel-made-easy"
  , News "Blazing Fast HTML" "/blog/blazing-fast-html"
--  , News "Elm&rsquo;s Time Traveling Debugger" "http://debug.elm-lang.org"
  , News "Elm package manager" "/blog/announce/package-manager"
  , News "Elm REPL" "/blog/announce/repl"
  , News "Hot-swapping in Elm" "/blog/interactive-programming"
...
--  , News "Elm in VentureBeat" "http://venturebeat.com/2013/07/26/why-i-designed-a-front-end-programming-language-from-scratch/"
  , News "Elm and Prezi" "/blog/announce/elm-and-prezi"
--  , News "Escape from Callback Hell" "/blog/escape-from-callback-hell"
--  , News "Making Pong" "/blog/making-pong"
  ]
...
releases =
  [ Release "0.19" "/blog/small-assets-without-the-headache" "Smaller assets, faster compiler" "Aug 2018"
  , Release "0.18" "/blog/the-perfect-bug-report" "New debugger with session import/export" "Nov"
  , Release "0.17" "/blog/farewell-to-frp" "Add subscriptions, remove signals" "May 2016"
  , Release "0.16" "/blog/compilers-as-assistants" "Even better error messages!" "Nov"
  , Release "0.15.1" "/blog/compiler-errors-for-humans" "Dramatically improved error messages" "Jun"
  , Release "0.15" "/blog/announce/0.15" "Tasks, better HTTP library" "Apr"
  , Release "0.14.1" "https://groups.google.com/forum/#!topic/elm-announce/6zRwjN68Ap0" "HTML through main" "Jan 2015"
  , Release "0.14" "/blog/announce/0.14" "Package manager, parallel builds, JSON" "Dec"
  , Release "0.13" "/blog/announce/0.13" "Debugging with elm-reactor" "Sep"
  , Release "0.12.3" "/blog/announce/0.12.3" "3D rendering with WebGL" "May"
  , Release "0.12.1" "/blog/announce/0.12.1" "Fast Immutable Arrays" "May"
  , Release "0.12" "/blog/announce/0.12" "Interactive UI Elements" "Mar"
  , Release "0.11" "/blog/announce/0.11" "Drastically improved FFI with ports" "Jan 2014"
  , Release "0.10.1" "/blog/announce/0.10.1" "Package manager integration" "Dec"
  , Release "0.10" "/blog/announce/0.10" "Strings, Colors, Operators" "Oct"
  , Release "0.9" "/blog/announce/0.9" "Fast and reliable type inference" "Aug"
  , Release "0.8" "/blog/announce/0.8" "HTML/JS integration" "May"
  , Release "0.7.1" "/blog/announce/0.7.1" "Libraries for touch, either, and keyboard" "Feb"
  , Release "0.7" "/blog/announce/0.7" "Extensible records" "Jan 2013"
  , Release "0.6" "/blog/announce/0.6" "Whitespace sensitivity" "Dec"
  , Release "0.5" "/blog/announce/0.5" "Libraries for dictionaries, sets, and automata" "Oct"
  , Release "0.4" "/blog/announce/0.4" "Markdown" "Sep"
