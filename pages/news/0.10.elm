 ...
 * [Strings](#strings) &mdash; switch to a
   [new representation](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/String)
   that is significantly faster
 * [Nice Colors](#nice-default-colors) &mdash; use [Tango color palette](https://tango.freedesktop.org/Tango_Icon_Theme_Guidelines) by default
...
[improved documentation](https://package.elm-lang.org/),
...
[a new string library](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/String) that
...
common uses of strings. The [new String library](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/String)
...
[package.elm-lang.org](https://package.elm-lang.org/) were fairly minimal.
...
[`uncons`](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/String#uncons) which
...
I mean, [`String.length`](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/String#length)
...
[the new color library](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Color) uses
[the Tango palette](https://tango.freedesktop.org/Tango_Icon_Theme_Guidelines)
for default colors:

<div style="width:100%; display:inline-block; text-align:center;">
<a href="https://tango.freedesktop.org/Tango_Icon_Theme_Guidelines">
...
[The new default colors](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Color#built-in-colors)
...
[the official Tango names](https://tango.freedesktop.org/static/cvs/tango-art-tools/palettes/Tango-Palette.svg)
...
DSLs](https://c2.com/cgi/wiki?EmbeddedDomainSpecificLanguage). Hypothetical
...
but since `(||)` [short ciruits](https://en.wikipedia.org/wiki/Short-circuit_evaluation),
...
nice in Elm code and [online](https://package.elm-lang.org/) and (2) to make docs
useful for entirely separate projects. I want to support things like
[Hoogle](https://www.haskell.org/hoogle/)-style type search or creating
IDE features like inline-docs or autocompletion. To reach these two goals,
this release introduces:

* a new format for documentation, [described here](https://package.elm-lang.org/help/documentation-format)
* [a new home for documentation](https://package.elm-lang.org/)
* `elm-doc` which extracts Elm documentation into JSON

Now my favorite part this project is [the search bar on the docs site](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/).
...
like [`(<~)`](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Signal#<~)
and [`(~)`](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Signal#~). The best part of
...
* The `Matrix2D` library has been renamed [`Transform2D`](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Transform2D).
  This library is actually made up of [augmented matrices](https://en.wikipedia.org/wiki/Affine_transformation#Augmented_matrix)
  that let you represent translations, and we wanted to make that clearer.

* Add <span style="font-family:monospace;">
  ([Random.floatList](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Random#floatList) : Signal Int -> Signal [Float])</span><br/>
  Thanks to [Max Goldstein](https://github.com/mgold)!

* Fix the `remove` function in [the `Dict`
  library](https://package.elm-lang.org/packages/elm-lang/core/1.0.0/Dict) based on [Matt Might's
  work on this topic](https://matt.might.net/articles/red-black-delete/). Thank you
  to [Max New](https://github.com/maxsnew) for taking on this arduous task!

* Switch to [`language-ecmascript`](https://hackage.haskell.org/package/language-ecmascript)
