...
[pipe]: https://package.elm-lang.org/packages/elm-lang/core/4.0.5/Basics#|&gt;
...
[range]: https://package.elm-lang.org/packages/elm-lang/core/5.0.0/List#range
...
Thank you to everyone submitting [SSCCE](https://sscce.org/)’s to the [error message catalog][catalog]! It has been really exciting to see how direct feedback like this has improved things since we started this process in Elm 0.16.
