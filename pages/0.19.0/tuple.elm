...
main =
  Skeleton.hint "From Tuples to Records" """

The largest tuple possible in Elm has three entries. Once you get to four, it is best to just make a record with named entries.
