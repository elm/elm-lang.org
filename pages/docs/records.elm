...
you probably want
[custom types](https://guide.elm-lang.org/types/custom_types.html). So if you
find yourself struggling with records to make them act like objects, keep in
mind that there is probably a different tool for the job.
