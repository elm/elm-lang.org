  ...
  switch(Tuple3$namehrefclr_5[0]){
   ...
   return function(){
    ...
    return function(){
     ...
     return Graphics.link(Tuple3$namehrefclr_5[2])(below(accent_9)(butn_10));}();}();
  }
  throw "Non-exhaustive pattern match in case";}();};
...
} catch (e) {Elm.main=function() {var msg = ('<br/><h2>Your browser may not be supported. Are you using a modern browser?</h2>' + '<br/><span style="color:grey">Runtime Error in Website.Skeleton module:<br/>' + e + '<br/><br/>The problem may stem from an improper usage of:<br/>Text.color, accent1, accent2, accent3, accent4, below, beside, lightGrey, mediumGrey</span>');document.body.innerHTML = Text.monospace(msg);throw e;};}