...
In this post we will be looking into [Pong in Elm](https://github.com/elm-lang/elm-lang.org/blob/master/src/examples/pong.elm):
...
playing around with your own ideas.
 ...
 [src]: https://github.com/elm-lang/elm-lang.org/blob/master/src/examples/pong.elm
...
And that is it, [Pong in Elm](https://github.com/elm-lang/elm-lang.org/blob/master/src/examples/pong.elm)!
